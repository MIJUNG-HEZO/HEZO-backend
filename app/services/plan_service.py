...
from app.core.circuit_breakers import call_breaker_async, redis_plans_cache_breaker
...
class PlanService:
    ...
    async def _get_cached_plans(self) -> PlanListResponse | None:
        try:
            ...
            raw = await call_breaker_async(
                redis_plans_cache_breaker, cache_get(client, _PLANS_CACHE_KEY)
            )
